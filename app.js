...
// ---------------------------------------------------------------------
const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSf2FAA8qp5VYMW8QSPlwmbMPQkGVet53NufZCUtHt_PN-PUdA/viewform?usp=publish-editor";
...
// ---------------------------------------------------------------------
const COMMITTEES = [
  { name: "اللجنة التقنية والبرمجية", icon: "code-2", desc: "تطوير المشاريع البرمجية وتقديم الورش التقنية المتخصصة." },
  { name: "اللجنة الأكاديمية والتدريب", icon: "graduation-cap", desc: "الإشراف على المحتوى التدريبي وجودة الورش المقدمة." },
  ...
  { name: "لجنة الأمن السيبراني والشبكات", icon: "shield-check", desc: "الأنشطة المتخصصة في أمن المعلومات والشبكات." },
];
